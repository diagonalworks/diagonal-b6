...
export interface IsValidQueryProto {
}
...
export interface QueryProto {
  ...
  isValid?: IsValidQueryProto | undefined;
}
...
function createBaseIsValidQueryProto(): IsValidQueryProto {
  return {};
}

export const IsValidQueryProto = {
  encode(_: IsValidQueryProto, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): IsValidQueryProto {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseIsValidQueryProto();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
      }
  ...
  fromJSON(_: any): IsValidQueryProto {
    return {};
  },

  toJSON(_: IsValidQueryProto): unknown {
    const obj: any = {};
    return obj;
  },

  create<I extends Exact<DeepPartial<IsValidQueryProto>, I>>(base?: I): IsValidQueryProto {
    return IsValidQueryProto.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<IsValidQueryProto>, I>>(_: I): IsValidQueryProto {
    const message = createBaseIsValidQueryProto();
    return message;
  },
};
...
export const QueryProto = {
  encode(message: QueryProto, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.isValid !== undefined) {
      IsValidQueryProto.encode(message.isValid, writer.uint32(122).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 15:
          ...
          message.isValid = IsValidQueryProto.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): QueryProto {
    return {
      ...
      isValid: isSet(object.isValid) ? IsValidQueryProto.fromJSON(object.isValid) : undefined,
    };
  },
  ...
  toJSON(message: QueryProto): unknown {
    ...
    if (message.isValid !== undefined) {
      obj.isValid = IsValidQueryProto.toJSON(message.isValid);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<QueryProto>, I>>(object: I): QueryProto {
    ...
    message.mightIntersect = (object.mightIntersect !== undefined && object.mightIntersect !== null)
      ...
      : undefined;
    message.isValid = (object.isValid !== undefined && object.isValid !== null)
      ? IsValidQueryProto.fromPartial(object.isValid)
      : undefined;
    return message;
  },
};
