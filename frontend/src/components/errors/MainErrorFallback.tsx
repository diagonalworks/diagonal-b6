	...
	({ error, resetErrorBoundary }) => {
		...
		return (
			<div className=" bg-graphite-20  min-h-screen w-screen flex flex-col pt-32">
				<div className=" w-1/2 flex flex-col item-center mx-auto " role="alert">
					<h2 className="text-2xl font-medium text-center">
						Oh no! It seems like you've stumbled upon uncharted territory.
					</h2>

					<Button className="mt-4 mx-auto " onClick={resetErrorBoundary}>
						Refresh
					</Button>
