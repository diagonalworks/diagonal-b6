...
func TestRemoveTags(t *testing.T) {
	tags := b6.Tags{
		{Key: "startNode", Value: b6.StringExpression("23A9FC0E-CBAB-425C-A7C9-B3356F17AF52")},
		{Key: "roadNumber", Value: b6.StringExpression("A5202")},
		{Key: "endNode", Value: b6.StringExpression("541F7F78-ED83-40D9-9488-3FD36D169B69")},
		{Key: "class", Value: b6.StringExpression("A Road")},
	}
...
func TestCloneRelation(t *testing.T) {
	...
	c6.Tags = []b6.Tag{{Key: "type", Value: b6.StringExpression("route")}, {Key: "ref", Value: b6.StringExpression("C6")}}
...
func TestCloneCollection(t *testing.T) {
	collection := CollectionFeature{
		...
		Tags:         []b6.Tag{{Key: "by", Value: b6.StringExpression("chromatics")}},
	}
...
func TestMergePath(t *testing.T) {
	...
	cde.AddTag(b6.Tag{Key: "highway", Value: b6.StringExpression("service")})
...
func TestMergeArea(t *testing.T) {
	...
	gasholders.AddTag(b6.Tag{Key: "name", Value: b6.StringExpression("Gasholder Apartments")})
	...
	openreach.AddTag(b6.Tag{Key: "name", Value: b6.StringExpression("BT Openreach")})
	openreach.AddTag(b6.Tag{Key: "building", Value: b6.StringExpression("commercial")})
	openreach.AddTag(b6.Tag{Key: "building:levels", Value: b6.StringExpression("5")})
...
func TestMergeRelation(t *testing.T) {
	...
	cs3.Tags = []b6.Tag{{Key: "type", Value: b6.StringExpression("route")}, {Key: "ref", Value: b6.StringExpression("CS3")}, {Key: "name", Value: b6.StringExpression("East-West Cycle Superhighway")}}
...
func TestMergeCollection(t *testing.T) {
	...
	after := CollectionFeature{
		...
		Tags:         []b6.Tag{{Key: "carpenter", Value: b6.StringExpression("nonsense")}},
	}
