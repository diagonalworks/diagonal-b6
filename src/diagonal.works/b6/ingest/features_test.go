...
func TestRemoveTags(t *testing.T) {
	tags := b6.Tags{
		{Key: "startNode", Value: b6.NewStringExpression("23A9FC0E-CBAB-425C-A7C9-B3356F17AF52")},
		{Key: "roadNumber", Value: b6.NewStringExpression("A5202")},
		{Key: "endNode", Value: b6.NewStringExpression("541F7F78-ED83-40D9-9488-3FD36D169B69")},
		{Key: "class", Value: b6.NewStringExpression("A Road")},
	}
...
func TestCloneRelation(t *testing.T) {
	...
	c6.Tags = []b6.Tag{{Key: "type", Value: b6.NewStringExpression("route")}, {Key: "ref", Value: b6.NewStringExpression("C6")}}
...
func TestCloneCollection(t *testing.T) {
	collection := CollectionFeature{
		...
		Tags:         []b6.Tag{{Key: "by", Value: b6.NewStringExpression("chromatics")}},
	}
...
func TestMergePath(t *testing.T) {
	...
	cde.AddTag(b6.Tag{Key: "highway", Value: b6.NewStringExpression("service")})
...
func TestMergeArea(t *testing.T) {
	...
	gasholders.AddTag(b6.Tag{Key: "name", Value: b6.NewStringExpression("Gasholder Apartments")})
	...
	openreach.AddTag(b6.Tag{Key: "name", Value: b6.NewStringExpression("BT Openreach")})
	openreach.AddTag(b6.Tag{Key: "building", Value: b6.NewStringExpression("commercial")})
	openreach.AddTag(b6.Tag{Key: "building:levels", Value: b6.NewStringExpression("5")})
...
func TestMergeRelation(t *testing.T) {
	...
	cs3.Tags = []b6.Tag{{Key: "type", Value: b6.NewStringExpression("route")}, {Key: "ref", Value: b6.NewStringExpression("CS3")}, {Key: "name", Value: b6.NewStringExpression("East-West Cycle Superhighway")}}
...
func TestMergeCollection(t *testing.T) {
	...
	after := CollectionFeature{
		...
		Tags:         []b6.Tag{{Key: "carpenter", Value: b6.NewStringExpression("nonsense")}},
	}
