...
func ValidateRelationsAsAreas(buildWorld BuildOSMWorld, t *testing.T) {
	...
	expectedAreas := 1
	q := b6.Intersection{b6.NewIntersectsCap(cap), b6.Tagged{Key: "#building", Value: b6.NewStringExpression("yes")}}
...
func ValidateFindWithIntersectionQuery(buildWorld BuildOSMWorld, t *testing.T) {
	...
	q := b6.Intersection{b6.Tagged{Key: "#amenity", Value: b6.NewStringExpression("school")}, b6.Tagged{Key: "#building", Value: b6.NewStringExpression("yes")}}
...
func ValidateFindRelationsByFeature(buildWorld BuildOSMWorld, t *testing.T) {
	...
	if len(found) == 1 {
		expected := b6.Tag{Key: "#route", Value: b6.NewStringExpression("bicycle")}
