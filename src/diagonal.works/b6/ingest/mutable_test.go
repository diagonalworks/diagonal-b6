...
func osmPoint(id osm.NodeID, lat float64, lng float64) Feature {
	return &GenericFeature{
		...
		Tags: []b6.Tag{{Key: b6.PointTag, Value: b6.NewPointExpressionFromLatLng(s2.LatLngFromDegrees(lat, lng))}}}
}
...
func osmPath(id osm.WayID, points []Feature) *GenericFeature {
	...
	for i, point := range points {
		path.ModifyOrAddTagAt(b6.Tag{b6.PathTag, b6.NewFeatureIDExpression(point.FeatureID())}, i)
	}
	return &path
}
...
func ValidateReplaceFeatureWithAdditionalTag(w MutableWorld, t *testing.T) {
	...
	path.ModifyOrAddTag(b6.Tag{Key: "#highway", Value: b6.NewStringExpression("footway")})

	if err := addFeatures(w, start, end, path); err != nil {
		t.Fatal(err)
	}

	paths := b6.AllFeatures(w.FindFeatures(b6.Typed{b6.FeatureTypePath, b6.Tagged{Key: "#highway", Value: b6.NewStringExpression("footway")}}))
	if len(paths) != 1 || paths[0].FeatureID() != path.FeatureID() {
		t.Error("Expected to find one path")
	}

	paths = b6.AllFeatures(w.FindFeatures(b6.Typed{b6.FeatureTypePath, b6.Tagged{Key: "#bridge", Value: b6.NewStringExpression("yes")}}))
	if len(paths) != 0 {
		t.Error("Didn't expect to find any bridges")
	}

	path.Tags = append(path.Tags, b6.Tag{Key: "#bridge", Value: b6.NewStringExpression("yes")})
	w.AddFeature(path)
	paths = b6.AllFeatures(w.FindFeatures(b6.Typed{b6.FeatureTypePath, b6.Intersection{b6.Tagged{Key: "#highway", Value: b6.NewStringExpression("footway")}, b6.Tagged{Key: "#bridge", Value: b6.NewStringExpression("yes")}}}))
	if len(paths) != 1 || paths[0].FeatureID() != path.FeatureID() {
...
func ValidateUpdatePathConnectivity(w MutableWorld, t *testing.T) {
	...
	path.ModifyOrAddTagAt(b6.Tag{b6.PathTag, b6.NewFeatureIDExpression(b.FeatureID())}, 1)
...
func ValidateUpdateAreasByPointWhenChangingPointsOnAPath(w MutableWorld, t *testing.T) {
	...
	modifiedPath.ModifyOrAddTagAt(b6.Tag{b6.PathTag, b6.NewFeatureIDExpression(d.FeatureID())}, 1)
...
func ValidateUpdateAreasSharingAPointOnAPath(w MutableWorld, t *testing.T) {
	...
	modifiedPath.ModifyOrAddTagAt(b6.Tag{b6.PathTag, b6.NewFeatureIDExpression(h.FeatureID())}, 0)
	modifiedPath.ModifyOrAddTagAt(b6.Tag{b6.PathTag, b6.NewFeatureIDExpression(h.FeatureID())}, 3)
	if err := addFeatures(w, modifiedPath); err != nil {
		t.Fatal(err)
	}
...
func ValidateUpdateRelationsByFeatureWhenChangingRelations(w MutableWorld, t *testing.T) {
	...
	ab.ModifyOrAddTag(b6.Tag{b6.PathTag, b6.NewExpressions([]b6.AnyExpression{b6.FeatureIDExpression(a.FeatureID()), b6.FeatureIDExpression(b.FeatureID())})})

	bc := &GenericFeature{ID: FromOSMWayID(558345068)}
	bc.ModifyOrAddTag(b6.Tag{b6.PathTag, b6.NewExpressions([]b6.AnyExpression{b6.FeatureIDExpression(b.FeatureID()), b6.FeatureIDExpression(c.FeatureID())})})

	relation := NewRelationFeature(1)
	relation.RelationID = FromOSMRelationID(11139964)
	relation.Members[0] = b6.RelationMember{ID: ab.FeatureID()}
	relation.Tags = []b6.Tag{{Key: "type", Value: b6.NewStringExpression("route")}}
...
func ValidateUpdatingPathUpdatesS2CellIndex(w MutableWorld, t *testing.T) {
	...
	modifiedPath := NewFeatureFromWorld(w.FindFeatureByID(path.FeatureID())).(Feature)
	modifiedPath.ModifyOrAddTagAt(b6.Tag{b6.PathTag, b6.NewFeatureIDExpression(e.FeatureID())}, 2)
	modifiedPath.ModifyOrAddTagAt(b6.Tag{b6.PathTag, b6.NewFeatureIDExpression(f.FeatureID())}, 3)
...
func ValidateUpdatingPointLocationsUpdatesS2CellIndex(w MutableWorld, t *testing.T) {
	...
	// Eastern Handyside Canopy, East edge
	newC := &GenericFeature{ID: c.FeatureID(), Tags: []b6.Tag{{Key: b6.PointTag, Value: b6.NewPointExpressionFromLatLng(s2.LatLngFromDegrees(51.5358965, -0.1230551))}}}
	newD := &GenericFeature{ID: d.FeatureID(), Tags: []b6.Tag{{Key: b6.PointTag, Value: b6.NewPointExpressionFromLatLng(s2.LatLngFromDegrees(51.5370349, -0.1232719))}}}
...
func ValidateUpdatingPointLocationsWillFailIfAreasAreInvalidated(w MutableWorld, t *testing.T) {
	...
	modifiedPoint := &GenericFeature{ID: c.FeatureID(), Tags: []b6.Tag{{Key: b6.PointTag, Value: b6.NewPointExpressionFromLatLng(s2.LatLngFromDegrees(51.5368549, -0.1256275))}}}
...
func ValidateAddTagToExistingFeature(w MutableWorld, t *testing.T) {
	...
	caravan.AddTag(b6.Tag{Key: "name", Value: b6.NewStringExpression("Caravan")})
	if err := addFeatures(w, caravan); err != nil {
		t.Fatal(err)
	}

	if err := w.AddTag(caravan.FeatureID(), b6.Tag{Key: "amenity", Value: b6.NewStringExpression("restaurant")}); err != nil {
...
func ValidateRepeatedModificationChangingNodes(id osm.WayID, find func(b6.World) b6.Feature, w MutableWorld, t *testing.T) {
	...
	path.ModifyOrAddTag(b6.Tag{Key: "#highway", Value: b6.NewStringExpression("primary")})
	...
	for i := 0; i < len(points); i++ {
		...
		modifiedPath.ModifyOrAddTagAt(b6.Tag{b6.PathTag, b6.NewFeatureIDExpression(modifiedPoint.FeatureID())}, i)
...
func ValidateRepeatedModificationAddingNodes(id osm.WayID, find func(b6.World) b6.Feature, w MutableWorld, t *testing.T) {
	...
	for i := 0; i < len(newPoints); i++ {
		...
		for j := 0; j < len(found.References()); j++ {
			if j == 1 {
				newPath.ModifyOrAddTagAt(b6.Tag{b6.PathTag, b6.NewFeatureIDExpression(newPoints[i].FeatureID())}, insert)
				insert++
			}
			id := found.Reference(j).Source()
			newPath.ModifyOrAddTagAt(b6.Tag{b6.PathTag, b6.NewFeatureIDExpression(id)}, insert)
			insert++
		}
...
func ValidateAddSearchableTagToExistingFeature(w MutableWorld, t *testing.T) {
	...
	lighterman.AddTag(b6.Tag{Key: "name", Value: b6.NewStringExpression("The Lighterman")})
	lighterman.AddTag(b6.Tag{Key: "#amenity", Value: b6.NewStringExpression("restaurant")})

	if err := addFeatures(w, caravan, lighterman); err != nil {
		t.Fatal(err)
	}

	points := w.FindFeatures(b6.Typed{b6.FeatureTypePoint, b6.Tagged{Key: "#amenity", Value: b6.NewStringExpression("restaurant")}})
...
func ValidateChangeSearchableTagOnExistingFeature(w MutableWorld, t *testing.T) {
	...
	if err := w.AddTag(lighterman.FeatureID(), b6.Tag{Key: "#amenity", Value: b6.NewStringExpression("pub")}); err != nil {
		t.Fatalf("Failed to add tag: %s", err)
	}
...
func TestChangeTagsOnExistingPoint(t *testing.T) {
	caravan := osmPoint(2300722786, 51.5357237, -0.1253052)
	caravan.AddTag(b6.Tag{Key: "name", Value: b6.NewStringExpression("Caravan")})
	caravan.AddTag(b6.Tag{Key: "wheelchair", Value: b6.NewStringExpression("no")})
	...
	overlay.AddTag(caravan.FeatureID(), b6.Tag{Key: "amenity", Value: b6.NewStringExpression("restaurant")})
	overlay.AddTag(caravan.FeatureID(), b6.Tag{Key: "wheelchair", Value: b6.NewStringExpression("yes")})

	point := overlay.FindFeatureByID(caravan.FeatureID())

	expected := []b6.Tag{
		{Key: "name", Value: b6.NewStringExpression("Caravan")},
		{Key: "wheelchair", Value: b6.NewStringExpression("yes")},
		{Key: "amenity", Value: b6.NewStringExpression("restaurant")},
		{Key: b6.PointTag, Value: b6.NewPointExpressionFromLatLng(s2.LatLngFromDegrees(51.5357237, -0.1253052))},
	}
...
func TestChangeTagsOnExistingPath(t *testing.T) {
	...
	ab.AddTag(b6.Tag{Key: "highway", Value: b6.NewStringExpression("tertiary")})
	ab.AddTag(b6.Tag{Key: "lit", Value: b6.NewStringExpression("no")})
	...
	overlay := NewMutableOverlayWorld(base)
	overlay.AddTag(ab.FeatureID(), b6.Tag{Key: "cycleway:left", Value: b6.NewStringExpression("track")})
	overlay.AddTag(ab.FeatureID(), b6.Tag{Key: "lit", Value: b6.NewStringExpression("yes")})

	path := overlay.FindFeatureByID(ab.FeatureID())

	expected := []b6.Tag{
		{Key: "highway", Value: b6.NewStringExpression("tertiary")},
		{Key: "lit", Value: b6.NewStringExpression("yes")},
		{Key: "cycleway:left", Value: b6.NewStringExpression("track")},
		{Key: b6.PathTag, Value: b6.NewExpressions([]b6.AnyExpression{b6.FeatureIDExpression(a.FeatureID()), b6.FeatureIDExpression(b.FeatureID())})},
	}
...
func TestChangeTagsOnExistingArea(t *testing.T) {
	...
	lighterman.AddTag(b6.Tag{Key: "name", Value: b6.NewStringExpression("The Lighterman")})
	lighterman.AddTag(b6.Tag{Key: "wheelchair", Value: b6.NewStringExpression("no")})
	...
	overlay := NewMutableOverlayWorld(base)
	overlay.AddTag(lighterman.FeatureID(), b6.Tag{Key: "amenity", Value: b6.NewStringExpression("pub")})
	overlay.AddTag(lighterman.FeatureID(), b6.Tag{Key: "wheelchair", Value: b6.NewStringExpression("yes")})

	area := b6.FindAreaByID(lighterman.AreaID, overlay)

	expected := []b6.Tag{
		{Key: "name", Value: b6.NewStringExpression("The Lighterman")},
		{Key: "amenity", Value: b6.NewStringExpression("pub")},
		{Key: "wheelchair", Value: b6.NewStringExpression("yes")},
	}
...
func TestAddSearchableTagTagToExistingArea(t *testing.T) {
	...
	overlay := NewMutableOverlayWorld(base)
	overlay.AddTag(lighterman.FeatureID(), b6.Tag{Key: "#reachable", Value: b6.NewStringExpression("yes")})

	areas := b6.AllAreas(b6.FindAreas(b6.Tagged{Key: "#reachable", Value: b6.NewStringExpression("yes")}, overlay))
	if len(areas) != 1 {
...
func TestChangeTagsOnExistingRelation(t *testing.T) {
	...
	c6.AddTag(b6.Tag{Key: "type", Value: b6.NewStringExpression("route")})
	c6.AddTag(b6.Tag{Key: "network", Value: b6.NewStringExpression("lcn")})
	...
	overlay := NewMutableOverlayWorld(base)
	overlay.AddTag(c6.FeatureID(), b6.Tag{Key: "route", Value: b6.NewStringExpression("bicycle")})
	overlay.AddTag(c6.FeatureID(), b6.Tag{Key: "network", Value: b6.NewStringExpression("rcn")})

	relation := b6.FindRelationByID(c6.RelationID, overlay)

	expected := []b6.Tag{
		{Key: "type", Value: b6.NewStringExpression("route")},
		{Key: "route", Value: b6.NewStringExpression("bicycle")},
		{Key: "network", Value: b6.NewStringExpression("rcn")},
	}
...
func TestChangeTagsOnExistingCollection(t *testing.T) {
	...
	f13 := b6.Tag{Key: "13", Value: b6.NewStringExpression("Of all the stars")}
	f31 := b6.Tag{Key: "31", Value: b6.NewStringExpression("That man seems to me to be equal to the gods, sitting opposite of you..")}
	c.AddTag(f13)
	c.AddTag(f31)
	...
	overlay := NewMutableOverlayWorld(base)
	overlay.AddTag(c.FeatureID(), b6.Tag{Key: "13", Value: b6.NewStringExpression("Of all the stars, the loveliest")})

	collection := b6.FindCollectionByID(c.CollectionID, overlay)

	expected := []b6.Tag{
		{Key: "31", Value: b6.NewStringExpression("That man seems to me to be equal to the gods, sitting opposite of you..")},
		{Key: "13", Value: b6.NewStringExpression("Of all the stars, the loveliest")},
	}
...
func TestReturnModifiedTagsFromSearch(t *testing.T) {
	caravan := osmPoint(2300722786, 51.5357237, -0.1253052)
	caravan.AddTag(b6.Tag{Key: "name", Value: b6.NewStringExpression("Caravan")})
	caravan.AddTag(b6.Tag{Key: "#amenity", Value: b6.NewStringExpression("restaurant")})
	...
	points := overlay.FindFeatures(b6.Typed{b6.FeatureTypePoint, b6.Tagged{Key: "#amenity", Value: b6.NewStringExpression("restaurant")}})
	if !points.Next() {
		t.Fatal("Expected to find 1 point")
	}
...
func TestSettingTheSameTagMultipleTimesChangesTheValue(t *testing.T) {
	...
	overlay := NewMutableOverlayWorld(base)
	for i := 0; i < 4; i++ {
		overlay.AddTag(caravan.FeatureID(), b6.Tag{Key: "100m", Value: b6.NewStringExpression("yes")})
		overlay.AddTag(caravan.FeatureID(), b6.Tag{Key: "#200m", Value: b6.NewStringExpression("yes")})
	}

	expected := []b6.Tag{
		{Key: "name", Value: b6.NewStringExpression("Caravan")},
		{Key: "#amenity", Value: b6.NewStringExpression("restaurant")},
		{Key: "100m", Value: b6.NewStringExpression("yes")},
		{Key: "#200m", Value: b6.NewStringExpression("yes")},
		{Key: b6.PointTag, Value: b6.NewPointExpressionFromLatLng(s2.LatLngFromDegrees(51.5357237, -0.1253052))},
	}
...
func TestRemovedTag(t *testing.T) {
	...
	for i := 0; i < 4; i++ {
		...
		overlay.AddTag(caravan.FeatureID(), b6.Tag{Key: "#shop", Value: b6.NewStringExpression("supermarket")})
	}

	expected := []b6.Tag{
		{Key: "name", Value: b6.NewStringExpression("Caravan")},
		{Key: "#shop", Value: b6.NewStringExpression("supermarket")},
		{Key: b6.PointTag, Value: b6.NewPointExpressionFromLatLng(s2.LatLngFromDegrees(51.5357237, -0.1253052))},
	}
...
func TestConnectivityUnchangedFollowingTagModification(t *testing.T) {
	...
	for _, a := range before {
		m.AddTag(a.FeatureID(), b6.Tag{Key: "#reachable", Value: b6.NewStringExpression("yes")})
	}
...
func TestWatchModifiedTags(t *testing.T) {
	...
	cancel()
	overlay.AddTag(caravan.FeatureID(), b6.Tag{Key: "wheelchair", Value: b6.NewStringExpression("no")})
	expected := ModifiedTag{ID: caravan.FeatureID(), Tag: b6.Tag{Key: "wheelchair", Value: b6.NewStringExpression("yes")}, Deleted: false}
	if m != expected {
...
func TestPropagateModifiedTags(t *testing.T) {
	...
	w.AddTag(caravan.FeatureID(), b6.Tag{Key: "amenity", Value: b6.NewStringExpression("restaurant")})
...
func TestModifiedTagsOnPathWithPlainLatLngs(t *testing.T) {
	...
	path.ModifyOrAddTag(b6.Tag{b6.PathTag, b6.NewExpressions([]b6.AnyExpression{b6.FeatureIDExpression(caravan.FeatureID()), b6.PointExpression(s2.LatLngFromDegrees(51.535490, -0.125167)), b6.FeatureIDExpression(yumchaa.FeatureID())})})
	if err := base.AddFeature(path); err != nil {
		t.Fatal(err)
	}

	w := NewMutableTagsOverlayWorld(base)
	w.AddTag(path.FeatureID(), b6.Tag{Key: "#highway", Value: b6.NewStringExpression("path")})
...
func TestModifiedTagsFeatureFromArea(t *testing.T) {
	...
	path.ModifyOrAddTag(b6.Tag{b6.PathTag, b6.NewExpressions([]b6.AnyExpression{
	...
	area.SetPathIDs(0, []b6.FeatureID{path.FeatureID()})
	area.AddTag(b6.Tag{Key: "#leisure", Value: b6.NewStringExpression("playground")})
	...
	overlay := NewMutableOverlayWorld(base)
	overlay.AddTag(path.FeatureID(), b6.Tag{Key: "barrier", Value: b6.NewStringExpression("fence")})
...
func TestEachFeatureWithAPathDependingOnTheBaseWorld(t *testing.T) {
	...
	dishoom.AddTag(b6.Tag{Key: "name", Value: b6.NewStringExpression("Dishoom")})
...
func TestEachFeatureWithModifiedTags(t *testing.T) {
	caravan := osmPoint(2300722786, 51.5357237, -0.1253052)
	caravan.AddTag(b6.Tag{Key: "name", Value: b6.NewStringExpression("Caravan")})
	caravan.AddTag(b6.Tag{Key: "cuisine", Value: b6.NewStringExpression("coffee_shop")})
	...
	m := NewMutableOverlayWorld(base)
	m.AddTag(caravan.FeatureID(), b6.Tag{Key: "wheelchair", Value: b6.NewStringExpression("yes")})
...
func TestChangeSearchableTagOnFeatureInBaseWorld(t *testing.T) {
	...
	q := b6.Tagged{Key: "#amenity", Value: b6.NewStringExpression("restaurant")}
	found := b6.AllFeatures(overlay.FindFeatures(q))
	if len(found) != 3 {
		t.Fatalf("Expected to find 3 features, found %d", len(found))
	}

	if err := overlay.AddTag(lighterman.FeatureID(), b6.Tag{Key: "#amenity", Value: b6.NewStringExpression("pub")}); err != nil {
		t.Fatalf("Failed to add tag: %s", err)
	}
