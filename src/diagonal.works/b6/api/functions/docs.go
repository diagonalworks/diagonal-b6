...
var functionDocs = map[string]Doc{
	...
	"empty-points": Doc{Doc: "Deprecated\n", ArgNames: []string{}},
	...
	"find-point": Doc{Doc: "Return the point feature with the given ID.\n", ArgNames: []string{"id"}},
	"find-points": Doc{Doc: "Return a collection of the point features present in the world that match the given query.\nKeys are IDs, and values are features.\n", ArgNames: []string{"query"}},
	...
	"histogram": Doc{Doc: "Cause the given collection to be rendered as a histogram in the b6 UI, returning the same collection.\n", ArgNames: []string{"collection"}},
	...
	"reachable-points": Doc{Doc: "Deprecated.\n", ArgNames: []string{"origin","mode","distance","query"}},
